...
hmac_sha1::hmac_sha1(QObject *parent) : QObject(parent)
{
...
unsigned long int hmac_sha1::ft(
    int t,
    unsigned long int x,
    unsigned long int y,
    unsigned long int z
...
unsigned long int hmac_sha1::k(int t)
...
unsigned long int hmac_sha1::rotr(int bits, unsigned long int a)
...
unsigned long int hmac_sha1::rotl(int bits, unsigned long int a)
...
void hmac_sha1::hmac_sha1_start(
    unsigned char *key,
    int key_length,
    unsigned char *data,
    int data_length,
...
//            printf("k0\n");
    ...
    printf("k0xorIpad\n");
    for (size_t i = 0; i < sizeof(k0xorIpad); ++i) {
        printf("%02X ", (unsigned char)k0xorIpad[i]);
    }
    printf("k0xorIpad\n");
...
//    printf("step5data\r\n");
//    for (size_t i = 0; i < sizeof(step5data); ++i) {
//        printf("%02X ", (unsigned char)step5data[i]);
//    }
//    printf("step5data\r\n");
//    printf("datalength+b = %d", data_length+b);
