...
/* 水平滚动条移动 */
void WidgetPlot2D::label_set_text(double ddata1, double ddata2, double ddata3, double ddata4, double ddata5, double ddata6 )
{
    double decline_degree;
    ui->label_4->setText(QString::number(ddata1, 'f', 2));
    ui->label_5->setText(QString::number(ddata2, 'f', 2));
    ui->label_6->setText(QString::number(ddata3, 'f', 2));
    ui->label_10->setText(QString::number(ddata4, 'f', 2));
    ui->label_11->setText(QString::number(ddata5, 'f', 2));
    ui->label_12->setText(QString::number(ddata6, 'f', 2));

    decline_degree = qSqrt( qPow(ddata1 - ddata4, 2) + qPow(ddata2 - ddata5, 2) + qPow(ddata3 - ddata6, 2) ) / 5000.0;
    ui->label_13->setText(QString::number(decline_degree, 'f', 2));
}
